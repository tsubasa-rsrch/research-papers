...
A separate line of work, descending from Beggs & Plenz (2003) on neuronal avalanches and Bak et al. (1987) on self-organized criticality, asks whether biophysically realistic networks exhibit power-law statistical signatures characteristic of critical-state dynamics. Doherty et al. (2025; SUNY Downstate, *bioRxiv* 2025.01.13.632866) report self-organized and self-sustained ensemble activity patterns in a NEURON/NetPyNE model of mouse primary motor cortex. This work shares with Hux the use of biophysically detailed neurons and the interest in self-organized dynamics, but the question is different: SOC frameworks ask whether statistical signatures (power laws, universality classes) emerge, while Hux asks whether *functional* and *pathological* states emerge from a developmental sequence. Doherty et al. operate on an isolated motor cortex slice without explicit developmental staging or distinct neuromodulator systems; we treat them as the closest neighboring approach in the literature, complementary rather than competing.
