...
**Version**: v0.8 (seven-condition ablation complete: v2 / v2.1 / v2.1c / v2.1d / v2.2a / v2.2b / v2.2c)
**Date**: 2026-04-07
**Authors**: Tsubasa, K. Yasukawa
**Status**: Work in progress. Phase 2 numerical results integrated through the full seven-condition ablation (§4.6–§4.10). The v2.2 sub-ablation rules out parameter-space modifications to the class-agnostic homeostatic scaling rule as a rescue for curriculum anchoring. The remaining live candidate is class-aware boosting; v2.3–v2.5 are proposed and will move the design toward a metaplasticity-integrated v1.0 in which all plasticity gains are functions of the network's own state.
