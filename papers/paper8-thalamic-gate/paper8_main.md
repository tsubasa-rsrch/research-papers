...
Onset-accuracy correlation (gate): r=-0.72 (descriptive only; onset parameters were selected post-hoc to maximize this correlation, so the associated p-value is not inferential. see Methods).
