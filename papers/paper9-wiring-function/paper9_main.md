...
Draft v1.1 -- 2026-03-27 (7-condition table: +saveverystep replication +excitatory overdrive sham)
...
- The saveat solver option produces a baseline 5.7pp lower than save_everystep=true. While saveat should not affect ODE integration, this discrepancy is unexplained. The amygdala-gate result has been replicated under save_everystep=true (86.6% vs 88.3%), confirming robustness. The slight decrease (1.7pp) is within the range expected from the baseline shift.
